...
const OurProjects = () => {
  ...
  useEffect(() => {
    ...
    if (pathname === '/projects' && window.location.hash) {
      const id = hash.substring(1) // Remove the "#" symbol from the hash
      const element = document.getElementById(id)
      if (element) {
        element.scrollIntoView({ behavior: 'smooth' })
      }
    } else if (pathname === '/projects' && !window.location.hash) {
      window.scrollTo(0, 0)
    }
  }, [])
    ...
    <>
      <div className='px-4 lg:px-0 hero-gradient text-white flex flex-col justify-center items-center gap-40'>
        ...
        <div className='flex lg:flex-row flex-col items-center justify-center gap-40'>
          ...
          >
            <h2 className='text-[30px]'>{content.ourProjectsBlogDesc}</h2>
            {/* <h3 className='text-[25px]'>{content.ourProjectsWebDesc2}</h3> */}
            <a href='https://github.com/pkvarg/b-blog' target='_blank'>
              <img className='mt-10' src='/git-hub-green.webp' alt='git-hub' />
            </a>
          </div>
        </div>
        ...
        <div className='flex flex-col lg:flex-row justify-center items-center gap-10'>
          ...
          <p className='text-[30px] mt-2'>React</p>
          <img
            className='w-[15%] lg:w-[3%]'
            src='/firebase.webp'
            alt='firebase'
          />
          <p className='text-[30px] mt-2'>Firebase</p>
        </div>
        ...
        <div className='flex lg:flex-row flex-col items-center justify-center gap-40 '>
          <div className='flex flex-col justify-center items-center'>
            <h2 className='text-[30px]'>{content.ourProjectsWebDesc1}</h2>
            <h3 className='text-[25px]'>{content.ourProjectsWebDesc2}</h3>
            <a href='https://github.com/pkvarg/cesta-zivota' target='_blank'>
              <img
                id='cesta-zivota'
                className='mt-10'
                src='/git-hub-green.webp'
                alt='git-hub'
              />
            </a>
          </div>
        ...
        <div className='flex lg:flex-row flex-col items-center justify-center gap-40 '>
          <div className='flex flex-col justify-center items-center'>
            <h2 className='text-[30px]'>{content.ourProjectsWebDesc1}</h2>
            <h3 className='text-[25px]'>{content.offer3price}</h3>
            <a href='https://github.com/pkvarg/michaldovala' target='_blank'>
              <img
                id='michal-dovala'
                className='mt-10'
                src='/git-hub-green.webp'
          ...
          <motion.div
            ...
            className='flex justify-center'
          >
            <a href='https://www.michaldovala.sk' target='_blank'>
              <img className='w-[40rem]' src='/md.webp' alt='michaldovala.sk' />
            </a>
          </motion.div>
        </div>
        <div className='flex flex-col lg:flex-row justify-center items-center gap-10'>
          ...
          <img
            ...
            className='w-[45px] rounded-[60%]'
          />
          <p className='text-[30px] mt-2'> Next.js 14 </p>
          <img
            className='w-[12.5%] lg:w-[4%]'
            src='/typescript.webp'
            alt='typescript'
          />
          <p className='text-[30px] mt-2'>Typescript</p>
          <img
            className='w-[12.5%] lg:w-[4%]'
            src='/express.webp'
            alt='express.js'
